...
typedef struct menu_ctxt_s      menu_ctxt_t;
...
void                menu_ctx_init               (menu_t *menu, const char **tooltip);
...
menu_item_t        *menu_static_gfx_add     (menu_t *menu, uint16_t cell_x, uint16_t cell_y, gfx_texture *texture, int tile, int width, int height);
